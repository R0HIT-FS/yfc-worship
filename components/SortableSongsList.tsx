    ...
    >
      <div className="flex items-stretch gap-2">
        ...
        <button
          ...
          {...attributes}
          {...listeners}
          className="touch-none cursor-grab rounded-lg border px-3 text-gray-500 transition active:cursor-grabbing active:scale-95"
...
const MemoSortableSongCard =
  memo(SortableSongCard);

MemoSortableSongCard.displayName =
  "MemoSortableSongCard";
